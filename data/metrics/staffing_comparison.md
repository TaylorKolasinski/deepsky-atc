...
| **FULL** | 0 | 0.00 | 0 | 0 | 0 |
| **NORMAL** | 0 | 0.00 | 0 | 0 | 0 |
| **REDUCED** | 0 | 0.00 | 0 | 0 | 0 |
| **SHUTDOWN** | 0 | 0.00 | 0 | 0 | 0 |
| **NONE** | 0 | 0.00 | 0 | 0 | 0 |
...
|----------|--------------|---------------|---------------------|
| **FULL** | 0.00x | 0.02x | 0.0% |
| **NORMAL** | 0.00x | 0.03x | 0.0% |
| **REDUCED** | 0.00x | 0.04x | 0.0% |
| **SHUTDOWN** | 0.00x | 0.07x | 0.0% |
| **NONE** | 0.00x | 0.00x | 0.0% |

## Key Insights

- **Safety Degradation**: Safety score dropped 0.0 points (from 100.0 to 100.0)

- **AI vs Shutdown**: AI safety score (100.0) vs shutdown (100.0)
- **AI Conflict Performance**: 0.00 conflicts/hour vs 0.00 under shutdown
